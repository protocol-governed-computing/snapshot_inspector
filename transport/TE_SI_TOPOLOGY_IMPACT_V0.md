...
```yaml
fqdn: inspection::TE_SI_TOPOLOGY_IMPACT_V0
...
- { field: impacted_count     , from: surface.impacted_count }
- { field: impacted_namespaces, from: surface.impacted_namespaces }
- { field: impact             , from: surface.impact }
