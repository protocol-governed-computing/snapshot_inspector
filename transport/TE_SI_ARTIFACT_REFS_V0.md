...
```yaml
fqdn: inspection::TE_SI_ARTIFACT_REFS_V0
...
- { field: transitive , from: surface.transitive }
- { field: traversable, from: surface.traversable }
- { field: ref_count  , from: surface.ref_count }
- { field: dep_count  , from: surface.dep_count }
- { field: refs       , from: surface.refs }
- { field: deps       , from: surface.deps }
