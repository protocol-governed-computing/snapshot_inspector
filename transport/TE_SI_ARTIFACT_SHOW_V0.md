# TE_SI_ARTIFACT_SHOW_V0

**Kind:** Transport Egress Contract (Transport Standard V0 §7)
**Operation Identity:** `si.artifact.show`
...
output_contract:
- { field: artifact       , from: surface.artifact }
- { field: kind           , from: surface.kind }
- { field: domain         , from: surface.domain }
- { field: owner_subdomain, from: surface.owner_subdomain }
- { field: canonical_path , from: surface.canonical_path }
- { field: addresses      , from: surface.addresses }
- { field: canonical      , from: surface.canonical }
