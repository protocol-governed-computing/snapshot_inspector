...
```yaml
fqdn: inspection::TE_SI_STORE_CONSUMERS_V0
...
output_contract:
- { field: key         , from: surface.key }
- { field: store       , from: surface.store }
- { field: domain      , from: surface.domain }
- { field: workflows   , from: surface.workflows }
- { field: consumer_ccs, from: surface.consumer_ccs }
- { field: bindings    , from: surface.bindings }
