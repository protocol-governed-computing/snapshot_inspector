...
Declares `si.store.consumers` in full: what it admits, how it is presented, and which implementation
...
catalog:
  category: STORES
  label: Consumers
  summary: Which workflows and capability contracts reach a store, and through which binding.
