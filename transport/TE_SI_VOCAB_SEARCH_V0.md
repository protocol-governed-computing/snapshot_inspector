...
```yaml
fqdn: inspection::TE_SI_VOCAB_SEARCH_V0
...
output_contract:
- { field: term       , from: surface.term }
- { field: match_count, from: surface.match_count }
- { field: matches    , from: surface.matches }
