...
Declares `si.topology.impact` in full: what it admits, how it is presented, and which implementation
...
catalog:
  category: ARTIFACTS
  label: Impact
  summary: Transitive consumer closure — what a change to this artifact reaches.
...
handler:
  ...
  operation: si.topology.impact
  implementation:
    module: inspector.queries.topology_impact
    callable: topology_impact
  payload_template:
